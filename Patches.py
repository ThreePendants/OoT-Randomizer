...
def patch_rom(spoiler:Spoiler, world:World, rom:Rom):
    ...
    rom.write_bytes(0xB5D79B, [0x00, 0x00, 0x10, 0xFF, 0x00])
    rom.write_bytes(0xB5D7AC, [0x00, 0xFF, 0xFF, 0x00, 0x00])
    rom.write_bytes(0xB5D7BB, [0x03, 0xFF, 0xFF, 0x03, 0x12])
    rom.write_byte(0xB5D7C9, [0x00])
    rom.write_byte(0xB5D7D1, [0x00])
    rom.write_bytes(0xB5D7D9, [0x00, 0x00])
    rom.write_bytes(0xB5D814, [0x00, 0x00, 0x00, 0x00. 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00])
    rom.write_byte(0xB5D842, [0x00])
    rom.write_bytes(0xB5D844, [0x00, 0xFF, 0x10, 0xFF, 0x00, 0x00, 0xFF, 0x00, 0x00, 0xFF, 0xFF, 0x00, 0xFF, 0x00, 0x10, 0x00])
